...
print('MLR_spHum_1-15_Zoom.eps', '-depsc');
...
print('MLR_spHum_1-15_rSq.eps', '-depsc');
...
print('MLR_spHum_1-15_Stats.eps', '-depsc');
...
dynamicDateTicks()
legend('LEMS A Data','LEMS B Data','LEMS D Data', 'LEMS A MLR','LEMS B MLR','LEMS D MLR');
print('MLR_spHum_1-27_Zoom.eps', '-depsc');
...
print('MLR_spHum_1-27_rSq.eps', '-depsc');
...
dynamicDateTicks()
legend('Range Output','Range Target','StdDev Output','StdDev Target');
print('MLR_spHum_1-27_Stats.eps', '-depsc');