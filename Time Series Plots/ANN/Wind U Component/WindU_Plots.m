...
print('ANN_windU_1-15_Zoom.eps', '-depsc');
...
print('ANN_windU_1-15_rSq.eps', '-depsc');
...
print('ANN_windU_1-15_Stats.eps', '-depsc');
...
dynamicDateTicks()
legend('LEMS A Data','LEMS B Data','LEMS D Data', 'LEMS A ANN','LEMS B ANN','LEMS D ANN');
print('ANN_windU_1-27_Zoom.eps', '-depsc');
...
print('ANN_windU_1-27_rSq.eps', '-depsc');
...
dynamicDateTicks()
legend('Range Output','Range Target','StdDev Output','StdDev Target');
print('ANN_windU_1-27_Stats.eps', '-depsc');
