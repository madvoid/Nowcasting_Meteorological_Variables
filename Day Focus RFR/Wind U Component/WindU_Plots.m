...
print('RFR_windU_1-15_Zoom.eps', '-depsc');
...
print('RFR_windU_1-15_rSq.eps', '-depsc');
...
print('RFR_windU_1-15_Stats.eps', '-depsc');
...
dynamicDateTicks()
legend('LEMS A Data','LEMS B Data','LEMS D Data', 'LEMS A RFR','LEMS B RFR','LEMS D RFR');
print('RFR_windU_1-27_Zoom.eps', '-depsc');
...
print('RFR_windU_1-27_rSq.eps', '-depsc');
...
dynamicDateTicks()
legend('Range Output','Range Target','StdDev Output','StdDev Target');
print('RFR_windU_1-27_Stats.eps', '-depsc');