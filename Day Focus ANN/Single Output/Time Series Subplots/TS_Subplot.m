...
cd(homeDir);
print('ANN_TS_Combined_1-15', '-depsc');

fileID = fopen('ANN_Stats_1-15_RMSE.tex','w');
...
fileID = fopen('ANN_Stats_1-15_NRMSE.tex','w');
% fprintf(fileID, '\\begin{table}[]\n');
fprintf(fileID, '\\begin{tabular}{lcccccccccc}\n');
fprintf(fileID, '\\topline\n');
fprintf(fileID, 'Variable    &   A   &  B    &  D    &  E    &  F    &  G    &  H    &  L    & Range & StdDev \\\\ \n');
...
fileID = fopen('ANN_Stats_1-15_MeanBias.tex','w');
% fprintf(fileID, '\\begin{table}[]\n');
...
cd(homeDir);
print('ANN_TS_Combined_1-27', '-depsc');

fileID = fopen('ANN_Stats_1-27_RMSE.tex','w');
% fprintf(fileID, '\\begin{table}[]\n');
fprintf(fileID, '\\begin{tabular}{lcccccccccc}\n');
fprintf(fileID, '\\topline\n');
fprintf(fileID, 'Variable    &   A   &  B    &  D    &  E    &  F    &  G    &  H    &  L    & Range & StdDev \\\\ \n');
...
fileID = fopen('ANN_Stats_1-27_NRMSE.tex','w');
% fprintf(fileID, '\\begin{table}[]\n');
fprintf(fileID, '\\begin{tabular}{lcccccccccc}\n');
fprintf(fileID, '\\topline\n');
fprintf(fileID, 'Variable   &   A   &  B    &  D    &  E    &  F    &  G    &  H    &  L    & Range & StdDev \\\\ \n');
...
fileID = fopen('ANN_Stats_1-27_MeanBias.tex','w');
% fprintf(fileID, '\\begin{table}[]\n');
fprintf(fileID, '\\begin{tabular}{lcccccccc}\n');
fprintf(fileID, '\\topline\n');
fprintf(fileID, 'Variable    &   A   &  B    &  D    &  E    &  F    &  G    &  H    &  L     \\\\ \n');
